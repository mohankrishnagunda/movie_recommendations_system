...
def fetch_posters(movie_id):
    response = requests.get(
        'https://api.themoviedb.org/3/movie/{}?api_key=d543024474e640f3980a08dfd2750403'.format(movie_id))
    data = response.json()
    try:
...
def fetch_person_details(id_):
    data = requests.get(
        'https://api.themoviedb.org/3/person/{}?api_key=d543024474e640f3980a08dfd2750403'.format(id_)).json()
